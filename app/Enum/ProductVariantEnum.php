...
enum ProductVariantEnum: string
{
    ...
    {
        return match($this) {
            self::PRODUCTVARIANT_01 => 1,
            self::PRODUCTVARIANT_02 => 2,
            self::PRODUCTVARIANT_03 => 3,
            self::PRODUCTVARIANT_04 => 4,
            self::PRODUCTVARIANT_05 => 5,
            self::PRODUCTVARIANT_06 => 1,
            self::PRODUCTVARIANT_07 => 2,
            self::PRODUCTVARIANT_08 => 3,
            self::PRODUCTVARIANT_09 => 4,
            self::PRODUCTVARIANT_10 => 5,
            self::PRODUCTVARIANT_11 => 1,
            self::PRODUCTVARIANT_12 => 2,
            self::PRODUCTVARIANT_13 => 3,
            self::PRODUCTVARIANT_14 => 4,
            self::PRODUCTVARIANT_15 => 5,
            self::PRODUCTVARIANT_16 => 1,
            self::PRODUCTVARIANT_17 => 2,
            self::PRODUCTVARIANT_18 => 3,
            self::PRODUCTVARIANT_19 => 4,
            self::PRODUCTVARIANT_20 => 5,
            self::PRODUCTVARIANT_21 => 1,
            self::PRODUCTVARIANT_22 => 2,
        };
    }
